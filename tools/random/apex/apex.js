    ...
    if (characterChecked & loadoutChecked) {
        resultDiv.innerHTML = `<div class="row">
          <div class="column-chr">
            <div id="char_results"><img src="apex/assets/characters/char${char}.png"</img></div>
          </div>
          <div class="column-wep">
            <div class="column-wep-row">
                <div id="wep1_results"><img src="apex/assets/weapons/wep${first}.png"</img></div>
            </div>
            <div class="column-wep-row">
                <div id="wep2_results"><img src="apex/assets/weapons/wep${second}.png"</img></div>
            </div>
          </div>
        </div`
